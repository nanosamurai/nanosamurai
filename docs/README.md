...
- [SamuraiBFF API, WebSocket, authentication, storage, and UI](https://github.com/nanosamurai/samuraibff/tree/master/docs)
- [Xamurai speech services, diarization, timing, and performance](https://github.com/nanosamurai/xamurai/tree/master/docs)
- [Nanosamurai Python SDK and CLI](https://github.com/nanosamurai/nanosamurai-sdk)
- [SamuraiPersistor transcript persistence](https://github.com/nanosamurai/samuraipersistor)

Deployment-specific private infrastructure is not part of this public
documentation set.
